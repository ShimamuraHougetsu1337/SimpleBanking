...
- **ALWAYS apply Clean Code & SRP (Single Responsibility Principle)**: Ensure custom hooks handle logic and components only render UI. Break large components into smaller, reusable pieces. Use descriptive, self-documenting naming conventions.
